...
use crate::oauth::gemini::error::{Error, Result};
use crate::oauth::gemini::models::google::CloudCodeWrapper;
...
///
/// ```rust,ignore
/// use crate::oauth::gemini::transport::HttpClient;
///
...
///
/// ```rust
/// use crate::oauth::gemini::transport::HttpClientBuilder;
/// use std::time::Duration;
///
...
pub(crate) fn wrap_request(
    project_id: &str,
    model: &str,
    request: crate::oauth::gemini::models::google::GoogleRequest,
) -> CloudCodeWrapper {
...
///
/// ```
/// use crate::oauth::gemini::transport::http::mask_token;
///
...
pub fn build_api_path(streaming: bool) -> &'static str {
    if streaming {
        crate::oauth::gemini::constants::API_PATH_STREAM_GENERATE_CONTENT
    } else {
        crate::oauth::gemini::constants::API_PATH_GENERATE_CONTENT
    }
}
...
mod tests {
    ...
    fn test_wrap_request() {
        use crate::oauth::gemini::models::google::{Content, GoogleRequest, Part};
