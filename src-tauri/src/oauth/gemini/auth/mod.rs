...
//!
//! ```rust,ignore
//! use crate::oauth::gemini::auth::OAuthFlow;
...
//!
//! ```rust,ignore
//! use crate::oauth::gemini::auth::project::{discover_project, ProjectInfo};
//!
//! # async fn example() -> crate::oauth::gemini::Result<()> {
...
pub use crate::oauth::token::TokenInfo; // Use unified TokenInfo
