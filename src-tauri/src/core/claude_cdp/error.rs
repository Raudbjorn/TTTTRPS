//! Error types for the Claude Desktop CDP bridge.
...
pub enum ClaudeCdpError {
    ...
    #[error("no Claude conversation page found in browser - connected to CDP but this doesn't appear to be Claude Desktop")]
    NoClaudePageFound,
