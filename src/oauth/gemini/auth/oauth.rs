...
//!
//! ```rust,ignore
//! use crate::oauth::gemini::auth::oauth::{generate_pkce, generate_state, build_authorization_url};
//! use crate::oauth::gemini::DEFAULT_OAUTH_CONFIG;
//!
...
use super::TokenInfo;
use crate::oauth::gemini::constants::OAuthConfig;
...
///
/// ```
/// use crate::oauth::gemini::auth::oauth::generate_pkce;
///
/// let (verifier, challenge) = generate_pkce();
///
...
///
/// ```
/// use crate::oauth::gemini::auth::oauth::generate_state;
///
...
pub fn build_authorization_url(config: &OAuthConfig, challenge: &str, state: &str) -> String {
    ...
    tracing::info!("Built OAuth URL: {}", &url);
    tracing::debug!("OAuth config - auth_url: {}, client_id: {}", config.auth_url, config.client_id);
...
///
/// ```rust,ignore
/// use crate::oauth::gemini::auth::oauth::exchange_code;
/// use crate::oauth::gemini::DEFAULT_OAUTH_CONFIG;
///
...
///
/// ```rust,ignore
/// use crate::oauth::gemini::auth::oauth::refresh_token;
/// use crate::oauth::gemini::DEFAULT_OAUTH_CONFIG;
///
