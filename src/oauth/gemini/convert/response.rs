...
use crate::oauth::gemini::models::content::ContentBlock;
use crate::oauth::gemini::models::google::GoogleResponse;
use crate::oauth::gemini::models::response::{MessagesResponse, StopReason, Usage};
...
///
/// ```rust,ignore
/// use crate::oauth::gemini::convert::convert_response;
///
/// let google_response = /* ... */;
...
pub(crate) fn convert_response(response: &GoogleResponse, model: &str) -> MessagesResponse {
    ...
    MessagesResponse {
        ...
        role: crate::oauth::gemini::models::request::Role::Assistant,
        content,
...
mod tests {
    use super::*;
    use crate::oauth::gemini::models::google::{Candidate, Content, FunctionCall, Part, UsageMetadata};
    use serde_json::json;
    ...
    fn test_convert_simple_text_response() {
        ...
        assert_eq!(result.role, crate::oauth::gemini::models::request::Role::Assistant);
